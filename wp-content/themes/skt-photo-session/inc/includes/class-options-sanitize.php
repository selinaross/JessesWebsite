...
function of_recognized_background_repeat() {
	...
	$default = array(
		'no-repeat' => __( 'No Repeat', 'skt-photosession' ),
		'repeat-x'  => __( 'Repeat Horizontally', 'skt-photosession' ),
		'repeat-y'  => __( 'Repeat Vertically', 'skt-photosession' ),
		'repeat'    => __( 'Repeat All', 'skt-photosession' ),
		);
...
function of_recognized_background_position() {
	$default = array(
		'top left'      => __( 'Top Left', 'skt-photosession' ),
		'top center'    => __( 'Top Center', 'skt-photosession' ),
		'top right'     => __( 'Top Right', 'skt-photosession' ),
		'center left'   => __( 'Middle Left', 'skt-photosession' ),
		'center center' => __( 'Middle Center', 'skt-photosession' ),
		'center right'  => __( 'Middle Right', 'skt-photosession' ),
		'bottom left'   => __( 'Bottom Left', 'skt-photosession' ),
		'bottom center' => __( 'Bottom Center', 'skt-photosession' ),
		'bottom right'  => __( 'Bottom Right', 'skt-photosession')
		);
...
function of_recognized_background_attachment() {
	$default = array(
		'scroll' => __( 'Scroll Normally', 'skt-photosession' ),
		'fixed'  => __( 'Fixed in Place', 'skt-photosession')
		);
...
function of_recognized_font_styles() {
	$default = array(
		'normal'      => __( 'Normal', 'skt-photosession' ),
		'italic'      => __( 'Italic', 'skt-photosession' ),
		'bold'        => __( 'Bold', 'skt-photosession' ),
		'bold italic' => __( 'Bold Italic', 'skt-photosession' )
		);
