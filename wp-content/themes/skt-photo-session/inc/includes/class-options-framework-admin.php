...
class Options_Framework_Admin {
	...
	static function menu_settings() {
		...
		$menu = array(
            ...
            'page_title' => __( 'Theme Options', 'skt-photosession' ),
			'menu_title' => __( 'Theme Options', 'skt-photosession' ),
     ...
     */
	 function options_page() { ?>
	    ...
	    <h2 class="nav-tab-wrapper">
          ...
          <div style="padding-top:10px;font-size:15px;"><a href="<?php echo esc_url(SKT_THEME_URL_DIRECT); ?>" target="_blank"><?php _e('Buy PRO version for only $30 with more features.','skt-photosession'); ?></a></div>
	    ...
	    <div id="optionsframework-metabox" class="metabox-holder">
		    <div id="optionsframework" class="postbox"  style="width:72%; float:left;">
				...
				<div id="optionsframework-submit">
					<input type="submit" class="button-primary" name="update" value="<?php esc_attr_e( 'Save Options', 'skt-photosession' ); ?>" />
					<input type="submit" class="reset-button button-secondary" name="reset" value="<?php esc_attr_e( 'Restore Defaults', 'skt-photosession' ); ?>" onclick="return confirm( '<?php print esc_js( __( 'Click OK to reset. Any theme settings will be lost!', 'skt-photosession' ) ); ?>' );" />
					<div class="clear"></div>
				</div>
				</form>
			</div> <!-- / #container -->
	...
	function validate_options( $input ) {
		...
		if ( isset( $_POST['reset'] ) ) {
			add_settings_error( 'options-framework', 'restore_defaults', __( 'Default options restored.', 'skt-photosession' ), 'updated fade' );
	...
	function save_options_notice() {
		add_settings_error( 'options-framework', 'save_options', __( 'Options saved.', 'skt-photosession' ), 'updated fade' );
	}
