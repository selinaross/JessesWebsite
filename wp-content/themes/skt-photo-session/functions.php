...
function skt_photo_session_scripts() {
	wp_enqueue_style( 'skt_photo_session-gfonts', '//fonts.googleapis.com/css?family=Roboto+Condensed:400,300,300italic,400italic,700,700italic' );
	wp_enqueue_style( 'skt_photo_session-fonts', '//fonts.googleapis.com/css?family=Roboto:400,300,700');
	wp_enqueue_style( 'skt_photo_session-basic-style', get_stylesheet_uri() );
	if ( (function_exists( 'of_get_option' )) && (of_get_option('sidebar-layout', true) != 1) ) {
		if (of_get_option('sidebar-layout', true) ==  'right') {
			wp_enqueue_style( 'skt_photo_session-layout', get_template_directory_uri()."/css/layouts/content-sidebar.css" );
		}
		else {
			wp_enqueue_style( 'skt_photo_session-layout', get_template_directory_uri()."/css/layouts/sidebar-content.css" );
		}	
	}
	else {
		wp_enqueue_style( 'skt_photo_session-layout', get_template_directory_uri()."/css/layouts/content-sidebar.css" );
	...
	wp_enqueue_style( 'skt_photo_session-editor-style', get_template_directory_uri()."/editor-style.css", array('skt_photo_session-layout') );

	wp_enqueue_style( 'skt_photo_session-main-style', get_template_directory_uri()."/css/main.css", array('skt_photo_session-layout') );
	
	wp_enqueue_style( 'skt_photo_session-supersized-default-theme', get_template_directory_uri()."/css/supersized.css" );
	
	wp_enqueue_style( 'skt_photo_session-supersized-style', get_template_directory_uri()."/css/supersized.shutter.css" );
	
	wp_enqueue_script( 'skt_photo_session-supersized-slider', get_template_directory_uri() . '/js/supersized.3.2.7.min.js', array('jquery') );
	
	//wp_enqueue_script( 'skt_photo_session-superfish', get_template_directory_uri() . '/js/superfish.js', array('jquery') );
...
define('SKT_THEME_URL_DIRECT','http://www.sktthemes.net/themes/skt_photo_session_pro/');
